...
import { useDedicatedTrialPlanMachine } from "./machines";

export type DedicatedTrialInstanceFormProps = {
  formId: string;
...
export const DedicatedTrialInstanceForm: VoidFunctionComponent<
  DedicatedTrialInstanceFormProps
> = ({
  formId,
  onClickContactUs,
