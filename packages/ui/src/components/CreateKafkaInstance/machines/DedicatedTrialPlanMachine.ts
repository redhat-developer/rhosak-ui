...
export type DedicatedTrialPlanMachineContext = {
...
export const DedicatedTrialPlanMachine =
  ...
  createMachine(
    {
      ...
      tsTypes: {} as import("./DedicatedTrialPlanMachine.typegen").Typegen0,
      predictableActionArguments: true,
      schema: {
        context: {} as DedicatedTrialPlanMachineContext,
        events: {} as
          | { type: "fieldInvalid" }
        ...
        configuring: {
          ...
          states: {
            ...
            fields: {
              ...
              onDone: {
                target: "#DedicatedTrialPlanMachine.configuring.form.valid",
              },
            },
          },
          onDone: {
