...
export type PartitionSizeStackChartPerBrokerProps = {
...
export const StackChartPartitionSizePerBroker: FunctionComponent<
  PartitionSizeStackChartPerBrokerProps
> = ({
  partitions,
  broker,
  duration,
              ...
              >
                ...
                <ChartStack>
                  {chartData.map((value, index) => (
                    <ChartBar key={`chart-area-${index}`} data={value.area} />
                  ))}
                </ChartStack>
              </Chart>
            );
