  ...
  return fakeApi<GetKafkaInstanceMetricsResponse>(
    {
      ...
      bytesPerPartitionMetrics: selectedBroker
        ? {
            ...
            "test-topic-1 / 1": makeMetrics(duration, 0, 31, 10 ** 7),
            "test-topic-1 / 2": makeMetrics(duration, 0, 28, 10 ** 7),
            "test-topic-2 / 3": makeMetrics(duration, 0, 25, 10 ** 7),
            "test-topic-2 /4": makeMetrics(duration, 0, 22, 10 ** 7),
            "test-topic-2 / 5": makeMetrics(duration, 0, 21, 10 ** 7),
            ...
            "test-topic-4 / 9": makeMetrics(duration, 0, 14, 10 ** 7),
            "test-topic-4 / 10": makeMetrics(duration, 0, 11, 10 ** 7),
            "test-topic-4 / 11": makeMetrics(duration, 0, 10, 10 ** 7),
            "test-topic-4 / 12": makeMetrics(duration, 0, 9, 10 ** 7),
            "test-topic-4 / 13": makeMetrics(duration, 0, 8, 10 ** 7),
            "test-topic-1 / 14": makeMetrics(duration, 0, 7, 10 ** 7),
            "test-topic-2 / 15": makeMetrics(duration, 0, 7, 10 ** 7),
            "test-topic-3 / 16": makeMetrics(duration, 0, 6, 10 ** 7),
            "test-topic-4 / 17": makeMetrics(duration, 0, 5, 10 ** 7),
        ...
        : {
            ...
            "3, test-topic-2 / 0": makeMetrics(duration, 0, 23, 10 ** 7),
            "2, test-topic-2 / 1": makeMetrics(duration, 0, 28, 10 ** 7),
            "3, test-topic-2 / 3": makeMetrics(duration, 0, 14, 10 ** 7),
            ...
            "3, test-topic-2 / 4": makeMetrics(duration, 0, 2, 10 ** 7),
            "4, test-topic-2 / 5": makeMetrics(duration, 0, 15, 10 ** 7),
            "4, test-topic-3 / 8": makeMetrics(duration, 0, 17, 10 ** 7),
            "5, test-topic-3 / 0": makeMetrics(duration, 0, 5, 10 ** 7),
            "2, test-topic-3 / 1": makeMetrics(duration, 0, 1, 10 ** 7),
          },
  ...
  return fakeApi<GetTopicsMetricsResponse>(
    {
      ...
      metricsTopics: ["test-topic-1", "lorem-dolor-topic", "lorem-prism-topic"],
