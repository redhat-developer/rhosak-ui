...
"isJustCreated": "fetchSuccess";
        ...
        eventsCausingServices: {
          "api": "refresh" | "selectDuration" | "xstate.after(1000)#kafkaInstanceMetrics.callApi.failure" | "xstate.after(1000)#kafkaInstanceMetrics.initialLoading.failure" | "xstate.init";
        };
